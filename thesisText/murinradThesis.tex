...
All issues and ideas concerning this project are logged on the project web site http://code.google.com/p/mobile-voting-system/.
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=14cm]{figures/deploy}
