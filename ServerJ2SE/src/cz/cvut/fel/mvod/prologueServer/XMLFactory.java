...
import cz.cvut.fel.mvod.crypto.*;
...
public class XMLFactory {
    ...
    public boolean addRegistrationEntry(HashMap<String, String> values) {
        try {
            ...
            pass.setTextContent(new String(Base64.encode(CryptoUtils.passwordDigest(values.get("username"), values.get("pass1")),Base64.DEFAULT)));
